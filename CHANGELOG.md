...
### Changed
- feat: add version and package info helper functions (#52)


## [1.4.1] - 2025-11-15

### Changed
- refactor: use secrets for custom registry config (#50)


## [1.4.0] - 2025-11-15

### Changed
- feat: add publish to devpi workflow (#48)


## [1.3.0] - 2025-11-15

### Changed
- feat: migrate to UV package manager, fix package build (#46)


## [1.2.0] - 2025-11-15

### Changed
- feat: migrate to uv package manager, fix package build (#44)
